...
wxGnuPGShellAdvKeySettings::wxGnuPGShellAdvKeySettings(wxWindow *parent,
...
bool wxGnuPGShellAdvKeySettings::Create(wxWindow *parent, wxWindowID id,
...
////@begin wxGnuPGShellAdvKeySettings content construction
	...
	wxStaticText *itemStaticText5 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("Key &type:"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer3->Add(itemStaticText5, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

	wxBoxSizer *itemBoxSizer6 = new wxBoxSizer(wxVERTICAL);
	itemBoxSizer3->Add(itemBoxSizer6, 0,
			wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);

	wxArrayString m_keyTypeStrings;
	m_keyType = new wxChoice(itemDialog1, ID_ADVANCEDKEY_KEYTYPE,
			wxDefaultPosition, wxDefaultSize, m_keyTypeStrings, 0);
	...
	itemBoxSizer6->Add(m_generateSeparateFlag, 0,
			wxALIGN_LEFT | wxRIGHT | wxTOP, 5);

	wxBoxSizer *itemBoxSizer9 = new wxBoxSizer(wxHORIZONTAL);
	itemBoxSizer2->Add(itemBoxSizer9, 0,
	...
	wxStaticText *itemStaticText11 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("Key &size:"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer9->Add(itemStaticText11, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

	m_keySize = new wxTextCtrl(itemDialog1, ID_ADVANCEDKEY_KEYSIZE, _("2048"),
			wxDefaultPosition, wxSize(50, -1), 0);
	itemBoxSizer9->Add(m_keySize, 0,
			wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);

	wxStaticText *itemStaticText13 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("1024-4096"), wxDefaultPosition, wxDefaultSize, 0);
	...
	wxStaticText *itemStaticText16 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("E&xpiration:"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer14->Add(itemStaticText16, 0, wxALIGN_CENTER_VERTICAL | wxALL,
			5);

	m_expireNever = new wxRadioButton(itemDialog1, ID_ADVANCEDKEY_RADIO_NEVER,
			_("ne&ver"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP);
	m_expireNever->SetValue(true);
	itemBoxSizer14->Add(m_expireNever, 0,
			wxALIGN_CENTER_VERTICAL | wxRIGHT | wxTOP | wxBOTTOM, 5);
...
void wxGnuPGShellAdvKeySettings::OnAdvancedkeyRadioDateSelected(
...
void wxGnuPGShellAdvKeySettings::OnOkClick(wxCommandEvent &event) {
	if (!m_keySize->GetValue().IsNumber()) {
		...
		if (val < 1024 && val > 4096) {
			wxMessageBox(_("Key length must be a number in range 1024-4096."),
					_("Error"), wxOK);
			m_keySize->SetValue(wxT("2048"));
			return;
		}
