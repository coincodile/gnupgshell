...
wxGnuPGShellSettings::wxGnuPGShellSettings( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
    Init();
...
bool wxGnuPGShellSettings::Create( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
...
////@begin wxGnuPGShellSettings content construction
    ...
    wxStaticBox* itemStaticBoxSizer3Static = new wxStaticBox(itemDialog1, wxID_ANY, _("Default Key:"));
    wxStaticBoxSizer* itemStaticBoxSizer3 = new wxStaticBoxSizer(itemStaticBoxSizer3Static, wxVERTICAL);
    itemBoxSizer2->Add(itemStaticBoxSizer3, 1, wxGROW|wxALL, 2);

    m_keyListCtrl = new wxListView( itemDialog1, ID_SETTINGS_KEYLIST, wxDefaultPosition, wxSize(450, 200), wxLC_REPORT|wxLC_SINGLE_SEL );
    ...
    wxStaticBox* itemStaticBoxSizer5Static = new wxStaticBox(itemDialog1, wxID_ANY, _("Passphrase cache"));
    ...
    m_useCache = new wxCheckBox( itemDialog1, ID_SETTINGS_USE_CACHE, _T(""), wxDefaultPosition, wxDefaultSize, 0 );
    m_useCache->SetValue(false);
    itemStaticBoxSizer5->Add(m_useCache, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticText* itemStaticText7 = new wxStaticText( itemDialog1, wxID_STATIC, _("Keep passphrase for"), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer5->Add(itemStaticText7, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_cacheTime = new wxSpinCtrl( itemDialog1, ID_SETTINGS_CACHE_TIME, _T("0"), wxDefaultPosition, wxDefaultSize, wxSP_ARROW_KEYS, 0, 60, 0 );
    if (wxGnuPGShellSettings::ShowToolTips())
        m_cacheTime->SetToolTip(_("For unlimited use 0.\nWarning: It is unsecure!"));
    itemStaticBoxSizer5->Add(m_cacheTime, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticText* itemStaticText9 = new wxStaticText( itemDialog1, wxID_STATIC, _("minutes."), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer5->Add(itemStaticText9, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer10Static = new wxStaticBox(itemDialog1, wxID_ANY, _("Default keyserver:"));
    ...
    m_defServerCombo = new wxChoice( itemDialog1, ID_SETTINGS_SERVER_LIST, wxDefaultPosition, wxDefaultSize, m_defServerComboStrings, 0 );
    itemBoxSizer11->Add(m_defServerCombo, 1, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxButton* itemButton13 = new wxButton( itemDialog1, ID_SETTINGS_BTN_ADD, _("+"), wxDefaultPosition, wxSize(30, -1), 0 );
    if (wxGnuPGShellSettings::ShowToolTips())
    ...
    wxButton* itemButton14 = new wxButton( itemDialog1, ID_SETTINGS_BTN_DEL, _("-"), wxDefaultPosition, wxSize(30, -1), 0 );
    if (wxGnuPGShellSettings::ShowToolTips())
        itemButton14->SetToolTip(_("Delete selected server"));
    itemBoxSizer11->Add(itemButton14, 0, wxALIGN_CENTER_VERTICAL|wxALL, 1);

    wxStaticLine* itemStaticLine15 = new wxStaticLine( itemDialog1, ID_SETTINGS_STATICLINE, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL );
    ...
    m_keyListCtrl->Connect(ID_SETTINGS_KEYLIST, wxEVT_CONTEXT_MENU, wxContextMenuEventHandler(wxGnuPGShellSettings::OnContextMenu), NULL, this);
////@end wxGnuPGShellSettings content construction
    ...
    if ( m_selectedKey != wxNOT_FOUND ) { m_keyListCtrl->SetItem(m_selectedKey, 2, wxT("*")); }
...
//
//                if (i%2) { m_keyListCtrl->SetItemBackgroundColour(i, cl); } // odd lines color
//            }
//        }
//    }
}
...
{
    wxString server = wxGetTextFromUser(_("Input server address"), _("New key server"));
...
void wxGnuPGShellSettings::OnSettingsBtnDelClick( wxCommandEvent& event )
{
    ...
    if (i != wxNOT_FOUND) { m_defServerCombo->Delete(i); }
}
...
{
    if ( m_keyListCtrl->GetFirstSelected() == wxNOT_FOUND ) { return; }
