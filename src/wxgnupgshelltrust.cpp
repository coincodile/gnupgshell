...
wxGnuPGShellTrust::wxGnuPGShellTrust( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
    Init();
...
bool wxGnuPGShellTrust::Create( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
...
////@begin wxGnuPGShellTrust content construction
    ...
    wxStaticText* itemStaticText4 = new wxStaticText( itemDialog1, wxID_STATIC, _("User name:"), wxDefaultPosition, wxSize(60, -1), 0 );
    itemBoxSizer3->Add(itemStaticText4, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_trustName = new wxStaticText( itemDialog1, ID_TRUST_NAME, _("Static text"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    wxStaticText* itemStaticText7 = new wxStaticText( itemDialog1, wxID_STATIC, _("Key ID:"), wxDefaultPosition, wxSize(60, -1), 0 );
    itemBoxSizer6->Add(itemStaticText7, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_trustKeyID = new wxStaticText( itemDialog1, ID_TRUST_ID, _("Static text"), wxDefaultPosition, wxDefaultSize, 0 );
    itemBoxSizer6->Add(m_trustKeyID, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticBox* itemStaticBoxSizer9Static = new wxStaticBox(itemDialog1, wxID_ANY, _("Owner Trust"));
    ...
    m_isTrustUnknown = new wxRadioButton( itemDialog1, ID_RADIO_UNKNOWN, _("&Unknown"), wxDefaultPosition, wxDefaultSize, wxRB_GROUP );
    m_isTrustUnknown->SetValue(true);
    itemStaticBoxSizer9->Add(m_isTrustUnknown, 1, wxALIGN_LEFT|wxALL, 5);

    wxStaticText* itemStaticText11 = new wxStaticText( itemDialog1, wxID_STATIC, _("You don't know how much to trust this\nuser to verify other people's keys."), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer9->Add(itemStaticText11, 0, wxALIGN_LEFT|wxALL, 5);

    m_isTrustNever = new wxRadioButton( itemDialog1, ID_RADIO_NEVER, _("&Never"), wxDefaultPosition, wxDefaultSize, 0 );
    m_isTrustNever->SetValue(false);
    itemStaticBoxSizer9->Add(m_isTrustNever, 0, wxALIGN_LEFT|wxALL, 5);

    wxStaticText* itemStaticText13 = new wxStaticText( itemDialog1, wxID_STATIC, _("You don't trust this user at all to verify\nthe validity of other people's keys at all."), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer9->Add(itemStaticText13, 0, wxALIGN_LEFT|wxALL, 5);

    m_isTrustMarginal = new wxRadioButton( itemDialog1, ID_RADIO_MARGINAL, _("&Marginal"), wxDefaultPosition, wxDefaultSize, 0 );
    m_isTrustMarginal->SetValue(false);
    itemStaticBoxSizer9->Add(m_isTrustMarginal, 0, wxALIGN_LEFT|wxALL, 5);

    wxStaticText* itemStaticText15 = new wxStaticText( itemDialog1, wxID_STATIC, _("You don't trust this user's ability to verify the validity of other\npeople's keys enough to  consider keys valid based on his/her\nsole word.\nHowever, provided this user's key is valid, you will consider a\nkey signed by this user valid if it is also signed by at least other\ntwo marginally trusted users with valid keys."), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer9->Add(itemStaticText15, 0, wxALIGN_LEFT|wxALL, 5);

    m_isTrustFull = new wxRadioButton( itemDialog1, ID_RADIO_FULL, _("&Full"), wxDefaultPosition, wxDefaultSize, 0 );
    m_isTrustFull->SetValue(false);
    itemStaticBoxSizer9->Add(m_isTrustFull, 0, wxALIGN_LEFT|wxALL, 5);

    wxStaticText* itemStaticText17 = new wxStaticText( itemDialog1, wxID_STATIC, _("You trust this user's ability to verify the validity of other\npeople's keys so much, that you'll consider valid any key\nsigned by him/her, provided this user's key is valid."), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer9->Add(itemStaticText17, 0, wxALIGN_LEFT|wxALL, 5);

    m_isTrustUltimate = new wxRadioButton( itemDialog1, ID_RADIO_ULTIMATE, _("Ul&timate"), wxDefaultPosition, wxDefaultSize, 0 );
    m_isTrustUltimate->SetValue(false);
    itemStaticBoxSizer9->Add(m_isTrustUltimate, 0, wxALIGN_LEFT|wxALL, 5);

    wxStaticText* itemStaticText19 = new wxStaticText( itemDialog1, wxID_STATIC, _("You consider this key valid, and trust the user so much that\nyou will consider any key signed by him/her fully valid."), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticBoxSizer9->Add(itemStaticText19, 0, wxALIGN_LEFT|wxALL, 5);

    itemStaticBoxSizer9->Add(5, 5, 0, wxALIGN_LEFT|wxALL, 5);

    wxStaticText* itemStaticText21 = new wxStaticText( itemDialog1, wxID_STATIC, _("(Warning: This is intended to be used for keys you own. Don't \nuse it with other people's key unless you really know what you\nare doing)"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    itemBoxSizer22->Add(itemStdDialogButtonSizer23, 0, wxALIGN_CENTER_VERTICAL|wxALL, 5);
...
{
    if ( m_isTrustFull->GetValue() )     { return TRUST_FULLY; }
    if ( m_isTrustUltimate->GetValue() ) { return TRUST_ULTIMATELY; }
    if ( m_isTrustMarginal->GetValue() ) { return TRUST_MARGINALLY; }
    if ( m_isTrustNever->GetValue() )    { return TRUST_DO_NOT_TRUST; }
    if ( m_isTrustUnknown->GetValue() )  { return TRUST_DONT_KNOW; }
