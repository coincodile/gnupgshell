...
public:
    ...
    wxGnuPGShellAdvKeySettings( wxWindow* parent, wxWindowID id = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_IDNAME, const wxString& caption = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_TITLE, const wxPoint& pos = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_POSITION, const wxSize& size = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_SIZE, long style = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_STYLE );

    /// Creation
    bool Create( wxWindow* parent, wxWindowID id = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_IDNAME, const wxString& caption = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_TITLE, const wxPoint& pos = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_POSITION, const wxSize& size = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_SIZE, long style = SYMBOL_WXGNUPGSHELLADVKEYSETTINGS_STYLE );
