...
wxGnuPGShellFileCheck::wxGnuPGShellFileCheck(wxWindow *parent, wxWindowID id,
...
bool wxGnuPGShellFileCheck::Create(wxWindow *parent, wxWindowID id,
		const wxString &caption, const wxPoint &pos, const wxSize &size,
		long style) {
...
////@begin wxGnuPGShellFileCheck content construction
	...
	m_filesTabsCtrl = new wxNotebook(itemDialog1, ID_FILECHECK_TABBAR,
			wxDefaultPosition, wxSize(300, 100), wxBK_DEFAULT);
	...
	wxButton *itemButton6 = new wxButton(itemDialog1, ID_FILECHECK_CLOSE,
			_("&Close"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer4->Add(itemButton6, 0, wxALIGN_CENTER_VERTICAL | wxALL, 5);

	// Connect events and objects
	itemButton6->Connect(ID_FILECHECK_CLOSE, wxEVT_LEFT_UP,
			wxMouseEventHandler(wxGnuPGShellFileCheck::OnLeftUp), NULL, this);
