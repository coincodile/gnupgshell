...
wxGnuPGShellExpiration::wxGnuPGShellExpiration(wxWindow *parent, wxWindowID id,
...
bool wxGnuPGShellExpiration::Create(wxWindow *parent, wxWindowID id,
		const wxString &caption, const wxPoint &pos, const wxSize &size,
		long style) {
...
////@begin wxGnuPGShellExpiration content construction
	...
	m_expirationMode = new wxRadioBox(itemDialog1, ID_EXPIRATION_MODE, _T(""),
			wxDefaultPosition, wxDefaultSize, m_expirationModeStrings, 1,
			wxRA_SPECIFY_COLS);
	m_expirationMode->SetSelection(0);
	itemBoxSizer2->Add(m_expirationMode, 0, wxGROW | wxALL, 5);

	m_calendarCtrl = new wxCalendarCtrl(itemDialog1, ID_EXPIRATION_CALENDAR,
			wxDateTime(), wxDefaultPosition, wxDefaultSize,
			wxCAL_SUNDAY_FIRST | wxSUNKEN_BORDER);
	...
	itemBoxSizer2->Add(itemStdDialogButtonSizer5, 0,
			wxALIGN_CENTER_HORIZONTAL | wxALL, 5);
	wxButton *itemButton6 = new wxButton(itemDialog1, wxID_OK, _("&OK"),
