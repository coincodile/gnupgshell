...
class wxGnuPGShellFileManager: public wxFrame {
	DECLARE_CLASS (wxGnuPGShellFileManager)DECLARE_EVENT_TABLE()

public:
	/// Constructors
	wxGnuPGShellFileManager();
	wxGnuPGShellFileManager(wxWindow *parent, wxWindowID id =
			SYMBOL_WXGNUPGSHELLFILEMANAGER_IDNAME, const wxString &caption =
			SYMBOL_WXGNUPGSHELLFILEMANAGER_TITLE, const wxPoint &pos =
			SYMBOL_WXGNUPGSHELLFILEMANAGER_POSITION, const wxSize &size =
			SYMBOL_WXGNUPGSHELLFILEMANAGER_SIZE, long style =
			SYMBOL_WXGNUPGSHELLFILEMANAGER_STYLE);
