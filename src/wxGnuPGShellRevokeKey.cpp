...
wxGnuPGShellRevokeKey::wxGnuPGShellRevokeKey( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
    Init();
...
bool wxGnuPGShellRevokeKey::Create( wxWindow* parent, wxWindowID id, const wxString& caption, const wxPoint& pos, const wxSize& size, long style )
{
...
////@begin wxGnuPGShellRevokeKey content construction
    ...
    wxStaticText* itemStaticText5 = new wxStaticText( itemDialog1, wxID_STATIC, _("Key ID:"), wxDefaultPosition, wxDefaultSize, 0 );
    itemStaticText5->SetFont(wxFont(8, wxSWISS, wxNORMAL, wxBOLD, false, wxT("Tahoma")));
    itemFlexGridSizer4->Add(itemStaticText5, 0, wxALIGN_RIGHT|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_ids = new wxTextCtrl( itemDialog1, ID_REVOKEKEY_IDS, _T(""), wxDefaultPosition, wxSize(150, -1), wxTE_READONLY );
    itemFlexGridSizer4->Add(m_ids, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticText* itemStaticText7 = new wxStaticText( itemDialog1, wxID_STATIC, _("User Name:"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_names = new wxTextCtrl( itemDialog1, ID_REVOKEKEY_NAMES, _T(""), wxDefaultPosition, wxSize(150, -1), wxTE_READONLY );
    itemFlexGridSizer4->Add(m_names, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    wxStaticText* itemStaticText9 = new wxStaticText( itemDialog1, wxID_STATIC, _("Output:"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    itemFlexGridSizer4->Add(itemBoxSizer10, 0, wxGROW|wxALIGN_CENTER_VERTICAL|wxALL, 5);

    m_outputFile = new wxTextCtrl( itemDialog1, ID_TEXTCTRL, _("Select output file..."), wxDefaultPosition, wxSize(200, -1), wxTE_READONLY );
    itemBoxSizer10->Add(m_outputFile, 1, wxALIGN_CENTER_VERTICAL|wxRIGHT|wxTOP|wxBOTTOM, 5);

    wxButton* itemButton12 = new wxButton( itemDialog1, ID_BUTTON, _("Browse..."), wxDefaultPosition, wxDefaultSize, wxBU_EXACTFIT );
    itemBoxSizer10->Add(itemButton12, 0, wxALIGN_CENTER_VERTICAL|wxLEFT|wxTOP|wxBOTTOM, 5);
    ...
    m_reasonRadio = new wxRadioBox( itemDialog1, ID_REASON_RADIOBOX, _("Reason for the revocation"), wxDefaultPosition, wxDefaultSize, m_reasonRadioStrings, 0, wxRA_SPECIFY_ROWS );
    m_reasonRadio->SetSelection(0);
    itemBoxSizer2->Add(m_reasonRadio, 0, wxGROW|wxALL, 5);

    wxStaticText* itemStaticText14 = new wxStaticText( itemDialog1, wxID_STATIC, _("Your own reason:"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_ownReason = new wxTextCtrl( itemDialog1, ID_OWN_REASON_TEXT, _T(""), wxDefaultPosition, wxSize(-1, 75), wxTE_MULTILINE );
    itemBoxSizer2->Add(m_ownReason, 0, wxGROW|wxALL, 5);

    wxBoxSizer* itemBoxSizer16 = new wxBoxSizer(wxHORIZONTAL);
    itemBoxSizer2->Add(itemBoxSizer16, 0, wxGROW|wxALL, 5);

    wxStaticText* itemStaticText17 = new wxStaticText( itemDialog1, wxID_STATIC, _("Passphrase:"), wxDefaultPosition, wxDefaultSize, 0 );
    ...
    m_passphrase = new wxTextCtrl( itemDialog1, ID_REVOKEKEY_PASS, _T(""), wxDefaultPosition, wxDefaultSize, wxTE_PASSWORD );
...
{
    wxFileDialog *fd = new wxFileDialog(this, _("Select output file"), wxEmptyString, wxString::Format(wxT("%s_revoke.asc"),m_ids->GetValue().GetData()),
        _("ASC files (*.asc)|*.asc|PGP files (*.pgp)|*.pgp)|All files (*.*)|*.*"), wxFD_SAVE);
