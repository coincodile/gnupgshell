...
wxGnuPGShellPassKey::wxGnuPGShellPassKey(wxWindow *parent, wxWindowID id,
...
bool wxGnuPGShellPassKey::Create(wxWindow *parent, wxWindowID id,
		const wxString &caption, const wxPoint &pos, const wxSize &size,
		long style) {
...
////@begin wxGnuPGShellPassKey content construction
	...
	wxStaticBitmap *itemStaticBitmap4 = new wxStaticBitmap(itemDialog1,
			wxID_STATIC, wxNullBitmap, wxDefaultPosition, wxSize(48, 48), 0);
	itemBoxSizer3->Add(itemStaticBitmap4, 0, wxALIGN_CENTER_VERTICAL | wxALL,
			5);
	...
	wxStaticText *itemStaticText6 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("Please enter passkey for the folowing key:"), wxDefaultPosition,
			wxDefaultSize, 0);
	...
	m_userName = new wxStaticText(itemDialog1, ID_PASSKEY_USERNAME,
			_("<user_name>"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer7->Add(m_userName, 1,
	...
	m_keyID = new wxStaticText(itemDialog1, ID_PASSKEY_KEYID, _("<key_id>"),
			wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer10->Add(m_keyID, 1, wxALIGN_CENTER_VERTICAL | wxLEFT | wxRIGHT,
			5);

	wxStaticText *itemStaticText13 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("Current passkey:"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer5->Add(itemStaticText13, 0,
			wxALIGN_LEFT | wxLEFT | wxRIGHT | wxTOP, 5);

	m_currPass = new wxTextCtrl(itemDialog1, ID_PASSKEY_CURRENT_PASS, _T(""),
	...
	wxStaticText *itemStaticText15 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("New passkey:"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer5->Add(itemStaticText15, 0,
			wxALIGN_LEFT | wxLEFT | wxRIGHT | wxTOP, 5);

	m_passKey = new wxTextCtrl(itemDialog1, ID_PASSKEY_PASS, _T(""),
	...
	wxStaticText *itemStaticText17 = new wxStaticText(itemDialog1, wxID_STATIC,
			_("Confirm passkey:"), wxDefaultPosition, wxDefaultSize, 0);
	itemBoxSizer5->Add(itemStaticText17, 0,
			wxALIGN_LEFT | wxLEFT | wxRIGHT | wxTOP, 5);

	m_passConfirm = new wxTextCtrl(itemDialog1, ID_PASSKEY_CONFIRM, _T(""),
			wxDefaultPosition, wxDefaultSize, wxTE_PASSWORD);
	itemBoxSizer5->Add(m_passConfirm, 0, wxGROW | wxALL, 5);

	wxStaticLine *itemStaticLine19 = new wxStaticLine(itemDialog1,
			ID_STATICLINE2, wxDefaultPosition, wxDefaultSize, wxLI_HORIZONTAL);
	itemBoxSizer2->Add(itemStaticLine19, 0, wxGROW | wxALL, 5);

	wxBoxSizer *itemBoxSizer20 = new wxBoxSizer(wxHORIZONTAL);
	itemBoxSizer2->Add(itemBoxSizer20, 0, wxALIGN_RIGHT | wxALL, 5);

	wxStdDialogButtonSizer *itemStdDialogButtonSizer21 =
			new wxStdDialogButtonSizer;

	itemBoxSizer20->Add(itemStdDialogButtonSizer21, 0,
			wxALIGN_CENTER_VERTICAL | wxALL, 0);
	wxButton *itemButton22 = new wxButton(itemDialog1, wxID_OK, _("&OK"),
			wxDefaultPosition, wxDefaultSize, 0);
	itemButton22->SetDefault();
	itemStdDialogButtonSizer21->AddButton(itemButton22);

	wxButton *itemButton23 = new wxButton(itemDialog1, wxID_CANCEL,
