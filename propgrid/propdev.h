...
{
    WX_PG_DECLARE_EDITOR_CLASS()public:
    wxPGTextCtrlEditor() {}
...
public:
    ...
    WX_PG_DECLARE_BASIC_TYPE_METHODS()WX_PG_DECLARE_ATTRIBUTE_METHODS()
...
public:
    ...
    WX_PG_DECLARE_BASIC_TYPE_METHODS()WX_PG_DECLARE_EVENT_METHODS()
